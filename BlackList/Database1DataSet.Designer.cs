...
namespace BlackList {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class Table1DataTable : global::System.Data.TypedTableBase<Table1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public Table1Row AddTable1Row(string fName, string lName, string uName, string Email) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public Table1Row FindByuserID(int userID) {
        ...
        public partial class Table1Row : global::System.Data.DataRow {
            ...
            public int userID {
                get {
                    return ((int)(this[this.tableTable1.userIDColumn]));
                }
                set {
            ...
            public string fName {
                get {
                    try {
                        return ((string)(this[this.tableTable1.fNameColumn]));
                    }
                ...
                set {
                    this[this.tableTable1.fNameColumn] = value;
                }
            }
            ...
            public string lName {
                get {
                    try {
                        return ((string)(this[this.tableTable1.lNameColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                ...
                set {
                    this[this.tableTable1.lNameColumn] = value;
                }
            }
            ...
            public string uName {
                get {
                    try {
                        return ((string)(this[this.tableTable1.uNameColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                ...
                set {
                    this[this.tableTable1.uNameColumn] = value;
                }
            }
            ...
            public bool IsfNameNull() {
                return this.IsNull(this.tableTable1.fNameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetfNameNull() {
                this[this.tableTable1.fNameColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bool IslNameNull() {
                return this.IsNull(this.tableTable1.lNameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetlNameNull() {
                this[this.tableTable1.lNameColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bool IsuNameNull() {
                return this.IsNull(this.tableTable1.uNameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetuNameNull() {
                this[this.tableTable1.uNameColumn] = global::System.Convert.DBNull;
            }
...
namespace BlackList.Database1DataSetTableAdapters {
    ...
    public partial class Table1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Table1` WHERE ((`userID` = ?) AND ((? = 1 AND `fName` IS NULL) OR (`" +
                "fName` = ?)) AND ((? = 1 AND `lName` IS NULL) OR (`lName` = ?)) AND ((? = 1 AND " +
                "`uName` IS NULL) OR (`uName` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` " +
                "= ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Table1` (`fName`, `lName`, `uName`, `Email`) VALUES (?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Table1` SET `fName` = ?, `lName` = ?, `uName` = ?, `Email` = ? WHERE ((`userID` = ?) AND ((? = 1 AND `fName` IS NULL) OR (`fName` = ?)) AND ((? = 1 AND `lName` IS NULL) OR (`lName` = ?)) AND ((? = 1 AND `uName` IS NULL) OR (`uName` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::BlackList.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT userID, fName, lName, uName, Email FROM Table1";
        ...
        public virtual int Delete(int Original_userID, string Original_fName, string Original_lName, string Original_uName, string Original_Email) {
        ...
        public virtual int Insert(string fName, string lName, string uName, string Email) {
            if ((fName == null)) {
        ...
        public virtual int Update(string fName, string lName, string uName, string Email, int Original_userID, string Original_fName, string Original_lName, string Original_uName, string Original_Email) {
            if ((fName == null)) {
