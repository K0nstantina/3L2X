namespace Login
{
    partial class CreateAccountForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // CreateAccGroupBox
            // 
            resources.ApplyResources(this.CreateAccGroupBox, "CreateAccGroupBox");
            this.CreateAccGroupBox.Controls.Add(this.txt_firstname);
            this.CreateAccGroupBox.Controls.Add(this.btn_submit);
            this.CreateAccGroupBox.Controls.Add(fNameLabel);
            this.CreateAccGroupBox.Controls.Add(uAgeLabel);
            this.CreateAccGroupBox.Controls.Add(this.txt_lastname);
            this.CreateAccGroupBox.Controls.Add(this.txt_age);
            this.CreateAccGroupBox.Controls.Add(lNameLabel);
            this.CreateAccGroupBox.Controls.Add(uPhoneLabel);
            this.CreateAccGroupBox.Controls.Add(this.txt_username);
            this.CreateAccGroupBox.Controls.Add(this.txt_phone);
            this.CreateAccGroupBox.Controls.Add(uNameLabel);
            this.CreateAccGroupBox.Controls.Add(uRecoverEmailLabel);
            this.CreateAccGroupBox.Controls.Add(this.txt_password);
            this.CreateAccGroupBox.Controls.Add(this.txt_recoveremail);
            this.CreateAccGroupBox.Controls.Add(uPasswordLabel);
            this.CreateAccGroupBox.Controls.Add(uEmailLabel);
            this.CreateAccGroupBox.Controls.Add(this.txt_email);
            ...
            this.CreateAccGroupBox.ResumeLayout(false);
            this.CreateAccGroupBox.PerformLayout();
